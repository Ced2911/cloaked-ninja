...
if exist "%GIT_VERSION_FILE%" (
	rem // Skip updating the file if PCSXR_GIT_VERSION_NO_UPDATE is 1.
	findstr /B /C:"#define PCSXR_GIT_VERSION_NO_UPDATE 1" "%GIT_VERSION_FILE%" > NUL
	if not errorlevel 1 (
		goto done
	)
)
...
if errorlevel 1 (
	...
	echo const char *PCSXR_GIT_VERSION = "unknown"; >> "%GIT_VERSION_FILE%"
	goto done
)
...
echo // This is a generated file. > "%GIT_VERSION_FILE%"
echo. >> "%GIT_VERSION_FILE%"
echo const char *PCSXR_GIT_VERSION = "%GIT_VERSION%"; >> "%GIT_VERSION_FILE%"
echo. >> "%GIT_VERSION_FILE%"
echo // If you don't want this file to update/recompile, change to 1. >> "%GIT_VERSION_FILE%"
echo #define PCSXR_GIT_VERSION_NO_UPDATE 0 >> "%GIT_VERSION_FILE%"
