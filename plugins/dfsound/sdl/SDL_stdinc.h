...
#else
extern DECLSPEC long SDLCALL strtol(const char *string, char **endp,
                                        int base);
#endif
...
#else
extern DECLSPEC Sint64 SDLCALL strtoll(const char *string, char **endp,
                                           int base);
#endif
...
#else
#define SDL_atoi(X)     strtol(X, NULL, 0)
#endif
...
#else
extern DECLSPEC int SDLCALL snprintf(char *text, size_t maxlen,
                                         const char *fmt, ...);
#endif
