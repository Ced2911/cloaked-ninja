...
////////////////////////////////////////////////////////////////////////
uint8_t ubPaletteBuffer[256][4];
int           iHiResTextures=0;
bk_texture_t  gTexMovieName=0;
bk_texture_t  gTexBlurName=0;
bk_texture_t  gTexFrameName=0;
bk_texture_t  gTexName;                               // binded texture
...
void InitializeTextureStore() 
{
 ...
 texturepart=(uint8_t *)malloc(256*256*4);
...
bk_texture_t BlackFake15BitTexture(void)
{
	/*
...
void DefineSubTextureSort(void)
{
	...
	if(!gTexName)
	{
		gTexName = BK_CreateTexture(256, 256);
		BK_SetTextureData(gTexName, 256, 256, texturepart);
	}
	BK_SetSubTextureData(gTexName, XTexS, YTexS,
